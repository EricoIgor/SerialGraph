...
public class SerialTest extends ApplicationFrame implements SerialPortEventListener {
    ...
    public SerialTest(String title) {
        super(title);
        initialize();
        ...
        final TimeSeries series = new TimeSeries("Volts ", Millisecond.class);
        this.datasets[0] = new TimeSeriesCollection(series);
        final NumberAxis rangeAxis = new NumberAxis("Volts");
        ...
        final JFreeChart chart = new JFreeChart("Carga do Capacitor", plot);
    ...
    public synchronized void serialEvent(SerialPortEvent oEvent) {
        if (oEvent.getEventType() == SerialPortEvent.DATA_AVAILABLE) {
            try {
                ...
                //this.lastValue[0] = new Integer(inputLine).intValue();
                this.lastValue[0] = Float.parseFloat(inputLine) ;
    ...
    public static void main(String[] args) throws Exception {
        final SerialTest demo = new SerialTest("Aplicação de Medição");
        demo.pack();
